...
heart_disease_model = pickle.load(open(os.path.join(base_path, "heartdisease.sav"), 'rb'))
parkinsons_model = pickle.load(open(os.path.join(base_path, "parkinsons.sav"), 'rb'))
bmi_model = pickle.load(open(os.path.join(base_path, "bmi_classifier.pkl"), 'rb'))
bmi_scaler = pickle.load(open(os.path.join(base_path, "scaler.pkl"), 'rb'))
